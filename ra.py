...
account_sid = 'AC21271be6fd46c587ca1a4fff4045c9cb'
auth_token = 'c1abdba9bcee6ce4f41d716a25ae7f73'
...
def make_call(to_number):
    try:
        call = client.calls.create(
            to=to_number,
            from_='+17632252704',  # Your Twilio phone number
...
if __name__ == "__main__":
    # Replace 'to_number' with the number you want to call
    make_call('+91 9035903245')  
